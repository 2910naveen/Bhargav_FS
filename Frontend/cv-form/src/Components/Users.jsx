...
const Users = () => {
    ...
    console.log("bhargav state: ", state)
        ...
        <div className="container">
            ...
            <form>
                ...
                <input className="form-control" style={{
                    ...
                    color: "#0c0c0c",
                }} value={user.phone} onChange={(e) => { handleChange(e) }} type="tel" name="phone" placeholder="Enter your number"   minlength="9"
                maxlength="14" />
